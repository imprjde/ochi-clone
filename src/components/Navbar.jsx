  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed z-[999] w-full px-16 py-6 bg-zinc-200 bg-opacity-40 font-['Neue Montreal'] flex justify-between items-center"
      >
        <div className="logo text-black text-3xl">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
