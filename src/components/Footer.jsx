const Footer = () => {
  return (
    <div className="w-full flex gap-5 py-10 px-10 h-screen bg-zinc-900">
      <div className="w-1/2 flex flex-col justify-between h-full  font-['Founders Grotesk X Condensed'] font-[650]">
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] font-[650] uppercase leading-none -mb-10">
          Presentations
          <div className="dets font-['Neue_Montrel'] mt-10">
